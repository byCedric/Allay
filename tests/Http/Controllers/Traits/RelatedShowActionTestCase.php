...
use ByCedric\Allay\Tests\Stubs\Http\Controllers\Traits\RelatedShowAction;
use ByCedric\Allay\Tests\Stubs\Resource\RelatableResource;
use ByCedric\Allay\Tests\Stubs\Resource\Resource;
use Mockery;

class RelatedShowActionTestCase extends \ByCedric\Allay\Tests\TestCase
{
    /**
     * Get a working instance of the related show action trait.
     *
     * @return \ByCedric\Allay\Tests\Stubs\Http\Controllers\Traits\RelatedShowAction
     */
    protected function getInstance()
    {
        return new RelatedShowAction();
    }
    ...
    public function testRelatedResourceThatImplementsReadableIsCalled()
    {
        ...
        $resolver->shouldReceive('getSubId')
            ->atLeast()->once()
            ->andReturn('2337');
    ...
    public function testRelatedResourceWithoutReadableIsUsable()
    {
        ...
        $relation->shouldReceive('findOrFail')
            ->with('2337')
            ->once();
